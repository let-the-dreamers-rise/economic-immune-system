...
exports.getEconomicDecision = void 0;
...
const getEconomicDecision = async (action, amount, walletContext, recipient, immuneContext) => {
    const ai = new genai_1.GoogleGenAI({ apiKey: process.env.API_KEY || process.env.GEMINI_API_KEY || "" });
    const prompt = `
    ACTION PROPOSAL:
    Target: ${action}
            ...
            responseSchema: {
                ...
                properties: {
                    ...
                    suggested_constraints: {
                        type: genai_1.Type.OBJECT,
                        properties: {
                            max_amount: { type: genai_1.Type.NUMBER },
                            frequency_limit: { type: genai_1.Type.STRING },
...
exports.getEconomicDecision = getEconomicDecision;
